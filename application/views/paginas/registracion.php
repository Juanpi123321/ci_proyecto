...
<div class="container-fluid fondo-principal">
	<div class="container fondo-2">
		...
		<div class="row">
			...
			<?php echo form_open('persona_controller/registrar_persona', ['class' => 'form-signin', 'role' => 'form']); ?>
				<div class="margen-izq col-xs-11 col-sm-5 col-md-5 col-md-push-0 col-lg-5">			
					...
					<?php echo form_input(['name' => 'nombre', 'id' => 'nombre' , 'class' => 'form-control', 'required' => 'required', 'autofocus' => 'autofocus','type' => 'text', 'value' => set_value('nombre')]); ?>
					<br>					
					<label class="control-label" for="textinput">Apellidos:</label>
					<?php echo form_input(['name' => 'apellido', 'id' => 'apellido' , 'class' => 'form-control', 'required' => 'required','type' => 'text', 'value' => set_value('apellido')]); ?>
					<br>	
