	...
	<nav role="navigation" class="navbar navbar-default">
		...
		<div id="barra-navegacion" class="collapse navbar-collapse">
			...
			<?php if (!$this->cart->contents()){	?>
				<a style="margin-left: 35%;" class="btn btn-default btn-lg" data-toggle="tooltip" data-placement="bottom" title="El carrito esta vacio" href="<?php echo base_url();?>carrito_controller"><span class="glyphicon glyphicon-shopping-cart"></span></a>
  			    <?php } else {  ?>
				<a style="margin-left: 35%;" class="btn btn-primary btn-lg" data-toggle="tooltip" data-placement="bottom" title="El carrito esta cargado" href="<?php echo base_url();?>carrito_controller"><span class="glyphicon glyphicon-shopping-cart"></span></a>
				<?php } ?>
